...
void FCompositingPass::Render(const std::shared_ptr<FEditorViewportClient>& Viewport)
{
    ...
    Graphics->DeviceContext->PSSetShaderResources(static_cast<UINT>(EShaderSRVSlot::SRV_Scene), 1, &ViewportResource->GetRenderTarget(EResourceType::ERT_PostProcessCompositing)->SRV);
